...
const Addpost = async () => {
  ...
  return (
    <div className="w-full h-fit shrink-0 rounded-2xl flex-col justify-center items-center px-7 py-5 shadow-md text-sm border-[1px] bg-slate-50">
      {/* avator and textbox */}
      <div className="flex gap-3 ">
        ...
        <div className="flex items-center justify-center">
          <Button className=" items-center w-24 rounded-full bg-[#FF4E01] text-white hover:text-[#FF4E01] hover:drop-shadow-lg hover:bg-white hover:text-base h-fit cursor-pointer gap-2 text-center justify-center">
            <span>Post</span>
          </Button>
        </div>
      </div>
      ...
      {/* post options */}
      <div className=" w-full flex gap-5 items-center justify-center mt-2 overflow-x-auto flex-nowrap scrollbar-hide">
