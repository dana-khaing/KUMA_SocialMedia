...
export default async function Useravator() {
  return (
    <div className="text-[#FF4E01] flex w-fit items-center justify-end cursor-default">
      <SignedIn>
        <div className="flex w-fit h-14 text-center justify-center items-center ">
          <UserButton
            showName={true}
            appearance={{
              elements: {
                ...
                button:
                  " text-[#ff4e02] text-md hover:text-white px-4 py-2 border-0 rounded-full hover:bg-[#FF4E01] hover:text-white",
              },
            }}
          />
        </div>
